...
public class ParceledListSlice<T extends Parcelable> implements Parcelable {
	...
	private ParceledListSlice(Parcel p, ClassLoader loader) {
        ...
        Parcelable.Creator<T> creator = ParcelCompat.readParcelableCreator(p, loader);
		...
		while (i < N) {
            ...
            final T parcelable = ParcelCompat.readCreator(p, creator, loader);
		...
		while (i < N) {
			...
			while (i < N && reply.readInt() != 0) {
                final T parcelable = ParcelCompat.readCreator(reply, creator, loader);
				verifySameType(listElementClass, parcelable.getClass());
	...
	public void writeToParcel(Parcel dest, int flags) {
		...
		if (N > 0) {
            ...
            ParcelCompat.writeParcelableCreator(dest, mList.get(0));
			int i = 0;
